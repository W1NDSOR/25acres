...
class User(AbstractUser):
    ...
    ## error prevention idk what it do
    groups = models.ManyToManyField(
    Group,
    verbose_name=_('groups'),
    blank=True,
    related_name='custom_users',  # Choose a related_name that doesn't clash
    )
    ...
    blank=True,
    related_name='custom_users_permissions',  # Choose a related_name that doesn't clash
    )
